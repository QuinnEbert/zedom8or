...
#pragma clang diagnostic ignored "-Wlogical-op-parentheses" // I am turning off && inside of || warnings for this one ancient piece of code so it doesn't drown out warnings relating to code from this millenium.
